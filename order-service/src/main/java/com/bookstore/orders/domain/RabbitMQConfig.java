...
public class RabbitMQConfig {
    ...
    DirectExchange exchange() {
        DirectExchange exchange = new DirectExchange(properties.orderEventsExchange());
    ...
    @Bean
    public RabbitTemplate rabbitTemplate(@Qualifier("connectionFactory") ConnectionFactory connectionFactory, ObjectMapper objectMapper) {
